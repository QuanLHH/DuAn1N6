 ...
 * @author ADMIN
 */
public class FromQL_TAIKHOAN extends javax.swing.JFrame {

    /**
     * Creates new form FromQL_TAIKHOAN
     */
    NguoiDungDAO daond = new NguoiDungDAO();
    TaiKhoanDAO daotk = new TaiKhoanDAO();
    int row = 0;
    public FromQL_TAIKHOAN() {
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(jLabel1)
                .addGap(18, 18, 18)
                .addComponent(tas, javax.swing.GroupLayout.PREFERRED_SIZE, 453, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FromQL_TAIKHOAN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FromQL_TAIKHOAN().setVisible(true);
            }
        });
    }
