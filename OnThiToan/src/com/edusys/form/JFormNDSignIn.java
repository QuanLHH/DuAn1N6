 ...
 * @author taola
 */
public class JFormNDSignIn extends javax.swing.JDialog {
    ...
    public JFormNDSignIn(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setInit();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFormNDSignIn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JFormNDSignIn dialog = new JFormNDSignIn(new javax.swing.JFrame(), true);
